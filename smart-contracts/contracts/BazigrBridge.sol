...
contract BazigrBridge is Ownable, ReentrancyGuard, Pausable {
    ...
    string public constant SOURCE_CHAIN = "CELO";
    ...
    /**
     * @dev Lock tokens on source chain (CELO) to bridge to target chain (Sepolia)
    ...
    /**
     * @dev Unlock tokens on target chain (Sepolia) after bridging from source chain (CELO)
